...
export function ActivityAdminFormTemplate({ activity, categories, saved, speakers, type }: ActivityAdminFormTemplateProps) {
  return (
    <div className="space-y-7">
      ...
      <ActivityForm activity={activity} categories={categories} speakers={speakers} type={type} />
    </div>
  );
}
