...
export default async function EditEventPage({ params, searchParams }: AdminActivityEditPageProps) {
  ...
  return <ActivityAdminFormTemplate activity={activity} categories={options.categories} saved={query.guardado === "1"} speakers={options.speakers} type="event" />;
}
