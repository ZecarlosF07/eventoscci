...
export function parseActivityFormData(formData: FormData): ActivityFormInput {
  return {
    ...
    certificate_general_price: stringValue(formData, "certificate_general_price"),
    certificate_member_price: stringValue(formData, "certificate_member_price"),
    certificate_mode: stringValue(formData, "certificate_mode") as ActivityFormInput["certificate_mode"],
