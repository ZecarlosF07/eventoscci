          ...
          {activities.map((activity) => {
            ...
            return (
              <tr key={activity.id}>
                ...
                <td className="px-5 py-4"><PriceDisplay generalPrice={activity.general_price} isFree={activity.is_free} memberPrice={activity.member_price} membersOnly={activity.members_only} /></td>
