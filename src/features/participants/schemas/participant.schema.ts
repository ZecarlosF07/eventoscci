...
export const participantFormSchema = z.object({
  ...
  first_names: z.string().trim().min(2, "Ingresa los nombres.").max(120),
  job_title: z.string().trim().min(2, "Ingresa el cargo.").max(150),
  last_names: z.string().trim().min(2, "Ingresa los apellidos.").max(120),
