    ...
    <ResponsiveTableFrame className="rounded-3xl" label="Directorio de personas">
      <table className="w-full min-w-[1100px] text-left text-sm">
        <thead className="border-b border-cci-100 bg-cci-50 text-slate-600">
          <tr><th className="px-5 py-4">Documento</th><th className="px-5 py-4">Participante</th><th className="px-5 py-4">Contacto</th><th className="px-5 py-4">Perfil</th><th className="px-5 py-4">Participaciones</th><th className="px-5 py-4">Acción</th></tr>
        </thead>
