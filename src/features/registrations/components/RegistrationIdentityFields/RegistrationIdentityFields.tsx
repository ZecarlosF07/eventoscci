  ...
  return (
    <div className="grid gap-5 sm:grid-cols-2">
      ...
      <FormField error={errors.document_number?.[0]} label="Número de documento" name="document_number" required>
        <Input autoComplete="off" id="document_number" maxLength={FIELD_LIMITS.documentNumber} name="document_number" required />
      </FormField>
      <FormField error={errors.first_names?.[0]} label="Nombres" name="first_names" required>
        <Input autoComplete="given-name" id="first_names" maxLength={FIELD_LIMITS.personName} name="first_names" required />
      </FormField>
      <FormField error={errors.last_names?.[0]} label="Apellidos" name="last_names" required>
        <Input autoComplete="family-name" id="last_names" maxLength={FIELD_LIMITS.personName} name="last_names" required />
      </FormField>
    </div>
  );
}
