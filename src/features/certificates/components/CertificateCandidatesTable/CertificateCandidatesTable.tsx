...
export function CertificateCandidatesTable({ activityId, candidates, templates }: CertificateCandidatesTableProps) {
  ...
  return <form className="space-y-4" method="post" onSubmit={onSubmit}>
    <div className="grid gap-3 rounded-2xl border border-cci-100 bg-white p-4 md:grid-cols-[1fr_1fr_auto]">
