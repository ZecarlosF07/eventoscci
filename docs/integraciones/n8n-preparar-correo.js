...
const visibleVirtualLink = (url) => `<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:20px 0 4px;border:2px solid ${accent};border-radius:14px;background:${brand}"><tr><td style="padding:18px"><p style="margin:0 0 8px;color:${accent};font-size:18px;font-weight:800;line-height:1.35">Tu enlace de acceso</p><p style="margin:0 0 14px;color:#ffffff;font-size:14px;line-height:1.55">Si el botón no funciona, copia este enlace y pégalo en tu navegador.</p><table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-radius:10px;background:#ffffff"><tr><td style="padding:14px"><a href="${escapeHtml(url)}" style="display:block;color:${brand};font-size:15px;font-weight:800;line-height:1.65;text-decoration:underline;word-break:break-all;overflow-wrap:anywhere">${escapeHtml(url)}</a></td></tr></table></td></tr></table>`;
...
let message = "";
let virtualAccessUrlForDisplay = "";
const actions = [];
const highlights = [];
...
if (
  ...
  virtualAccessUrlForDisplay = virtualAccessUrl;
